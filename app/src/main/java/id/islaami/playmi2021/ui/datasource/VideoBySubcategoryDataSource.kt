...
class VideoBySubcategoryDataSource(
    ...
    override fun loadInitial(
        ...
        disposable.add(
            repository.getAllVideoBySubcategory(1, categoryId, subcategoryId)
                .subscribe(
                    { result ->
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Video>) {
        ...
        disposable.add(
            repository.getAllVideoBySubcategory(params.key, categoryId, subcategoryId)
                .subscribe(
                    { result ->
                        if (!result.isNullOrEmpty()) {
